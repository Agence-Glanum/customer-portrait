...
def map_function(address):
    ...
    geojson_path = './utils/Geo/contour-des-departements.geojson'
    ...
    gdf_occurrences = gdf_departements.merge(address["Zip_code"], how='left',
                                             left_on='code', right_on='Zip_code')
    gdf_occurrences['Zip_code'] = gdf_occurrences['Zip_code'].fillna(0)
    fig = px.choropleth_mapbox(address, geojson=gdf_departements,
                               locations='Zip_code', color='Zip_code',
