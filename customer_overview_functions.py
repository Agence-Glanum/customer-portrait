...
def customer_overview_main_function(directory, invoices, orders, address, rfm, scaler, kmeans, average_clusters, df_sales, df_lines, 
                                     snapshot_start_date, snapshot_end_date, transformed_sales_filter):
